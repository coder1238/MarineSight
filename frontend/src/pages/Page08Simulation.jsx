...
export default function Page08Simulation({ onNavigate }) {
  ...
  React.useEffect(() => {
    ...
    const timer = setInterval(() => {
      setSimHour((prev) => {
        ...
        if (next > 72.0) next = 0.0; // Loop seamlessly
  ...
  // Compute live multi-physics simulation state using continuous simHour
  ...
  }, [caseData, simHour, windagePercent, currentMultiplier, particleDensity]);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-text-secondary mt-0.5">
            Coupled Lagrangian particle advection, atmospheric windage drag, and dynamic AIS vessel kinematics for Incident {caseData.incidentId} ({caseData.region}).
          </p>
        </div>
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-1.5 bg-ocean-light/50 px-2.5 py-1 rounded-lg border border-border-marine/50">
              ...
              {[500, 1500, 3000, 5000].map(cnt => (
                <button
                  key={cnt}
                  onClick={() => setParticleDensity(cnt)}
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            >
              ...
              <span>Vessel Movement & Wakes</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-8 bg-white border border-border-marine rounded-2xl p-3 shadow-marine-sm flex flex-col justify-between">
          ...
          <div className="mt-3 pt-3 border-t border-border-marine">
            <div className="flex items-center justify-between mb-2 text-xs font-mono flex-wrap gap-2">
              {/* Play / Step Buttons */}
              <div className="flex items-center gap-2">
                <button
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg bg-ocean text-white flex items-center justify-center hover:bg-ocean-deep shadow-sm"
                ...
                <span className="font-bold text-ocean-deep text-xs ml-1 flex items-center gap-1.5">
                  {isPlaying && <span className="w-2 h-2 rounded-full bg-emerald-500 animate-ping"></span>}
              ...
              <div className="flex items-center gap-1">
                <span className="text-[10px] text-text-muted font-bold mr-1">SPEED:</span>
          ...
          <div className="bg-white border border-border-marine rounded-2xl p-4 shadow-marine-sm">
            ...
            <div className="space-y-2 text-xs font-mono">
              <div className="p-2 bg-ocean-light rounded border border-border-marine/40">
                ...
                <span className="font-bold text-text-primary">{caseData.coordinates?.display || "14.82°N, 68.21°E"}</span>
              </div>
