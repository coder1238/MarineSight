...
export default function GISRealMap({
  ...
  useEffect(() => {
    ...
    if (layers.riskZones && activeCase.riskZones) {
  ...
  }, [mapReady, layers, mode, activeCase, spillPolygon, sarVessels, simulationTimestamp, simulationState, interceptorData, alerts]);
  ...
  return (
    <div className={`relative ${height} w-full rounded-xl overflow-hidden border border-border-marine bg-[#0A1E2F] shadow-inner select-none`}>
      {/* Real Map Container */}
      <div 
        ref={mapContainerRef} 
      ...
      <div className="absolute top-3 left-3 bg-[#0B2942]/90 backdrop-blur-sm border border-border-marine/40 text-white px-3 py-1.5 rounded-lg text-xs font-mono flex items-center gap-3 shadow-md z-[500]">
      ...
      <div className="absolute top-3 left-1/2 -translate-x-1/2 bg-[#0B2942]/90 backdrop-blur-sm border border-border-marine/40 p-1 rounded-xl shadow-md z-[500] flex items-center gap-1">
        <button
      ...
      {showControls && (
        <div className="absolute top-3 right-3 flex flex-col gap-1.5 z-[500]">
          <button
            onClick={() => {
              if (mapInstanceRef.current) {
      ...
      {showLayerMenu && (
        <div className="absolute top-12 right-12 w-56 bg-white border border-border-marine rounded-xl shadow-marine-lg p-2.5 z-[600] text-xs animate-fade-in">
      ...
      <div className="absolute bottom-2 left-2 right-2 bg-[#0B2942]/90 backdrop-blur-sm border border-border-marine/30 rounded-lg px-3 py-1.5 text-[10px] font-mono text-white flex items-center justify-between flex-wrap gap-2 z-[500]">
